...
class _MaterielPageState extends State<MaterielPage> {
  ...
  Future<void> checkNotification() async {
    final res = await http.get(Uri.parse('http://.../api/parc/allOperations'));
  ...
  Future<void> checkTechNotification() async {
    ...
    final res = await http.get(Uri.parse('http://.../api/parc/allOperations?userId=${widget.userId}'));
    if (res.statusCode == 200) {
      List ops = jsonDecode(res.body);
  ...
  Future<void> addMateriel() async {
    ...
    final response = await http.post(
      Uri.parse('http://.../api/materiel/ajouter'),
  ...
  Future<void> updateMateriel(int id) async {
    ...
    final response = await http.put(
      Uri.parse('http://.../api/materiel/$id'),
      headers: {'Content-Type': 'application/json'},
      body: jsonEncode({
        'type': cleanedType,
        'marque': marqueController.text.trim(),
  ...
  Future<void> fetchMateriels() async {
    ...
    String url = 'http://.../api/materiel/all';
  ...
  Future<void> deleteMateriel(int id) async {
    final response = await http.delete(Uri.parse('http://.../api/materiel/$id'));
  ...
  Future<void> goToHistoriqueAsTechnicien() async {
    if (widget.userId != null) {
      await http.patch(
        Uri.parse('http://.../api/parc/markSeen?userId=${widget.userId}'),
        headers: {'Content-Type': 'application/json'},
      );
